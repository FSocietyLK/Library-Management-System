...
public class GenerateReport extends javax.swing.JFrame {
        ...
        private void initComponents() {
                ...
                jComboBox1.setModel(
                                new javax.swing.DefaultComboBoxModel(new String[] { "01", "02", "03", "04", "05", "06",
        ...
        private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
                ...
                if (!jTextField1.getText().equals("")) {
                        ...
                        javax.swing.JOptionPane.showMessageDialog(this, "Enter ISBN or Bookself Number.", "Error",
        ...
        private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton3ActionPerformed
                ...
                java.awt.EventQueue.invokeLater(new Runnable() {
                        public void run() {
                                java.util.HashMap param = new java.util.HashMap();
                                param.put("datefrom", jComboBox2.getSelectedItem().toString() + "-"
                                                + jComboBox5.getSelectedItem().toString() + "-"
                                                + jComboBox1.getSelectedItem().toString());
                                param.put("dateto", jComboBox8.getSelectedItem().toString() + "-"
