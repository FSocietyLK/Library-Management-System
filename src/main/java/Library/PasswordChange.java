...
public class PasswordChange extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (java.util.Arrays.equals(password, "".toCharArray())
                    || java.util.Arrays.equals(newPW, "".toCharArray())
                    || java.util.Arrays.equals(confirmNewPW, "".toCharArray())) {
                javax.swing.JOptionPane.showMessageDialog(this, "Enter fields.", "Error",
                    ...
                    && java.util.Arrays.equals(newPW, confirmNewPW)) {
                int confirm = javax.swing.JOptionPane.showConfirmDialog(null,
                        "Do you really want to change the password?");
                if (confirm == javax.swing.JOptionPane.YES_OPTION) {
                    st.executeUpdate("UPDATE `user` SET Password='" + String.valueOf(newPW)
                            + "' WHERE Username='"
                            + Login.getUsername() + "'");
                    javax.swing.JOptionPane.showMessageDialog(this, "Password succesfully changed.",
                            "Successfull",
                ...
                javax.swing.JOptionPane.showMessageDialog(this, "Password mismatch.", "Error",
                        javax.swing.JOptionPane.ERROR_MESSAGE);
            } else {
                javax.swing.JOptionPane.showMessageDialog(this, "Incorrect password.", "Error",
                        javax.swing.JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton4ActionPerformed
        try {
            ...
            java.sql.ResultSet rs = st
                    .executeQuery("SELECT Email FROM `user` WHERE Username='" + Login.getUsername()
                            + "'");
            rs.next();
            ...
            if (user.equals("") || email.equals("")
                    || java.util.Arrays.equals(password, "".toCharArray())) {
                javax.swing.JOptionPane.showMessageDialog(this, "Enter fields.", "Error",
                        javax.swing.JOptionPane.ERROR_MESSAGE);
            } else if (email.equals(rs.getString(1))
                    && java.util.Arrays.equals(password, Login.getPassword())) {
                int confirm = javax.swing.JOptionPane.showConfirmDialog(null,
                        "Do you want to change the username?");
                if (confirm == javax.swing.JOptionPane.YES_OPTION) {
                    st.executeUpdate(
                            "UPDATE `user` SET Username='" + user + "' WHERE Username='"
                            + Login.getUsername() + "'");
                    javax.swing.JOptionPane.showMessageDialog(this, "Username succesfully changed.",
                            "Successfull",
                            javax.swing.JOptionPane.PLAIN_MESSAGE);
                }
                jTextField4.setText("");
                ...
                javax.swing.JOptionPane.showMessageDialog(this, "Incorrect e-mail.", "Error",
                        javax.swing.JOptionPane.ERROR_MESSAGE);
            } else if (!java.util.Arrays.equals(password, Login.getPassword())) {
                javax.swing.JOptionPane.showMessageDialog(this, "Incorrect password.", "Error",
                        javax.swing.JOptionPane.ERROR_MESSAGE);
