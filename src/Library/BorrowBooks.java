...
public class BorrowBooks extends javax.swing.JFrame {
        ...
        private void initComponents() {
                ...
                jTable1.setModel(new javax.swing.table.DefaultTableModel(
                                ...
                                new String[] {
                                                "Accession No", "ISBN", "Borrowed Date", "Member Id", "Name", "Year",
                                                "Semester"
                                }) {
                ...
                jPanel3Layout.setHorizontalGroup(
                                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 647,
                                                                Short.MAX_VALUE));
        ...
        private void jTextField6KeyReleased(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_jTextField6KeyReleased
                try {
                        ...
                        java.sql.ResultSet rs = st
                                        .executeQuery("SELECT Member_Id,Name,Year,Semester FROM `member` WHERE Member_Id = '"
                                                        + id + "'");
                        jTextField7.setText("");
                        jTextField8.setText("");
                        jTextField9.setText("");
        ...
        private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton4ActionPerformed
                try {
                        ...
                        java.sql.ResultSet rs = st.executeQuery(
                                        "SELECT l.Accession_No,l.Borrowed_Date,b.ISBN,m.Member_Id,m.Name,m.Year,m.Semester FROM member m INNER JOIN loan l ON m.Member_Id = l.Member_Id INNER JOIN accessionno a ON a.Accession_No = l.Accession_No INNER JOIN book b ON b.Book_No = a.Book_No");
        ...
        private void jTextField11KeyReleased(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_jTextField11KeyReleased
                try {
                        ...
                        java.sql.Statement st = con.createStatement();
                        java.sql.ResultSet rs = st.executeQuery(
                                        "SELECT Accession_No,Borrowed_Date,Due_Date FROM loan WHERE Member_Id = '" + id
                                                        + "'");
        ...
        private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
                try {
                        ...
                        java.sql.Connection con = java.sql.DriverManager.getConnection(
                                        ...
                                        "root", "");
                        java.sql.Statement st = con.createStatement();
                        java.sql.ResultSet rs1 = st.executeQuery(
                                        "SELECT Accession_No FROM accessionno WHERE Accession_No NOT IN (SELECT Accession_No FROM loan)");
                        if (rs1.next()) {
                                while (rs1.getString(1).equals(access)) {
                                        if (rs1.getString(1).equals(access)) {
                                                java.sql.ResultSet rs2 = st
                                                                .executeQuery("SELECT MAX(Borrow_Id) FROM loan");
                                                rs2.next();
                                                int bid = Integer.parseInt(rs2.getString(1));
                                                bid++;
                                                st.executeUpdate(
                                                                "INSERT INTO loan(Borrow_Id,Member_Id,Accession_No,Borrowed_Date,Due_Date,Loan_Status) VALUES ('"
                                                                                + bid + "','" + id + "','" + access
                                                                                + "',CURDATE(),DATE_ADD(CURDATE(),INTERVAL +10 DAY),'Not Returned')");
                                                javax.swing.JOptionPane.showMessageDialog(this,
                                                                "Borrow entry added successfully.",
                                                                "Successfull", javax.swing.JOptionPane.PLAIN_MESSAGE);
                                                jTextField7.setText("");
                                                jTextField8.setText("");
                                                jTextField9.setText("");
                                                jTextField6.setText("");
                                ...
                                javax.swing.JOptionPane.showMessageDialog(this, "There are no copies available.",
                                                "Error",
        ...
        private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton5ActionPerformed
                try {
                        ...
                        java.sql.Statement st = con.createStatement();
                        java.sql.ResultSet rs = st
                                        .executeQuery("SELECT Accession_No FROM loan WHERE Member_Id = '" + id + "'");
                        if (rs.next()) {
                                while (rs.getString(1).equals(access)) {
                                        if (rs.getString(1).equals(access)) {
                                                st.executeUpdate(
                                                                "UPDATE loan SET Return_Date=CURDATE(),Loan_Status='Returned' WHERE Accession_No='"
                                                                                + access + "'");
                                                javax.swing.JOptionPane.showMessageDialog(this,
                                                                "Book return successfully.", "Successfull",
                                ...
                                javax.swing.JOptionPane.showMessageDialog(this, "Enter fields.", "Error",
                                                javax.swing.JOptionPane.ERROR_MESSAGE);
                        } else {
                                javax.swing.JOptionPane.showMessageDialog(this, "There are no books to return.",
                                                "Error",
                                                javax.swing.JOptionPane.INFORMATION_MESSAGE);
                        }
                } catch (java.sql.SQLException sqle) {
