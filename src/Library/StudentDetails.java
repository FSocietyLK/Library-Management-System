...
public class StudentDetails extends javax.swing.JFrame {
        ...
        private void initComponents() {
                ...
                jComboBox1.setModel(
                                new javax.swing.DefaultComboBoxModel(
                                                new String[] { "2012", "2013", "2014", "2015", "2016" }));
        ...
        private void jTextField4KeyReleased(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_jTextField4KeyReleased
                try {
                        ...
                        java.sql.ResultSet rs = st.executeQuery(
                                        "SELECT Member_Id,Name,Year,Semester,Phone FROM `member` WHERE Member_Id = '"
                                                        + id + "'");
                        jLabel12.setText("-");
                        jLabel13.setText("-");
                        jLabel14.setText("-");
        ...
        private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
                try {
                        ...
                        try {
                                ...
                                if (id.equals("")) {
                                        javax.swing.JOptionPane.showMessageDialog(this, "Student ID cannot be empty.",
                                                        "Error",
                                                        javax.swing.JOptionPane.ERROR_MESSAGE);
                                } else if (name.equals("")) {
                                        javax.swing.JOptionPane.showMessageDialog(this, "Student name cannot be empty.",
                                                        "Error",
                                                        javax.swing.JOptionPane.ERROR_MESSAGE);
                                } else if (phone.equals("")) {
                                        javax.swing.JOptionPane.showMessageDialog(this,
                                                        "Student contact number cannot be empty.", "Error",
                                                        javax.swing.JOptionPane.ERROR_MESSAGE);
                                } else if (!(phone.length() == 10 && phone.matches("[0-9]+"))) {
                                        javax.swing.JOptionPane.showMessageDialog(this,
                                                        "Student contact number invalid.", "Error",
                                                        javax.swing.JOptionPane.ERROR_MESSAGE);
                                } else if (rt.next()) {
                                        javax.swing.JOptionPane.showMessageDialog(this,
                                                        "Student details already exist.", "Error",
                                                        javax.swing.JOptionPane.ERROR_MESSAGE);
                                } else {
                                        st.executeUpdate(
                                                        "INSERT INTO `member`(Member_Id,Name,Year,Semester,Phone) VALUES('"
                                                                        + id + "','"
                                                                        + name + "','" + year + "','" + semester + "','"
                                                                        + Integer.parseInt(phone) + "')");
                                        javax.swing.JOptionPane.showMessageDialog(this,
                                                        "Student details succesfully added.", "Successfull",
        ...
        private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
                try {
                        ...
                        if (id.equals("")) {
                                javax.swing.JOptionPane.showMessageDialog(this, "Student ID cannot be empty.", "Error",
                                                javax.swing.JOptionPane.ERROR_MESSAGE);
                        } else if (name.equals("")) {
                                javax.swing.JOptionPane.showMessageDialog(this, "Student name cannot be empty.",
                                                "Error",
                                ...
                                javax.swing.JOptionPane.showMessageDialog(this, "Student year invalid.", "Error",
                                                javax.swing.JOptionPane.ERROR_MESSAGE);
                        } else if (!(phone.length() == 10 && phone.matches("[0-9]+"))) {
                                javax.swing.JOptionPane.showMessageDialog(this, "Student contact number invalid.",
                                                "Error",
                                                javax.swing.JOptionPane.ERROR_MESSAGE);
                        } else {
                                st.executeUpdate("UPDATE `member` SET Name='" + name + "',Year='" + year
                                                + "',Semester='" + semester
                                                + "',Phone='" + Integer.parseInt(phone) + "' WHERE Member_Id='" + id
                                                + "'");
                                javax.swing.JOptionPane.showMessageDialog(this, "Student details succesfully changed.",
                                                "Successfull",
                                                javax.swing.JOptionPane.PLAIN_MESSAGE);
                        }
                } catch (java.sql.SQLException sqle) {
