...
public class SearchBooks extends javax.swing.JFrame {
        ...
        private void initComponents() {
                ...
                jTable1.setModel(new javax.swing.table.DefaultTableModel(
                                ...
                                new String[] {
                                                "Book No", "ISBN", "Accession No", "Title", "Author", "Publisher",
                                                "Edition", "Row No", "Col No"
                                }) {
        ...
        private void jTextField3KeyReleased(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_jTextField3KeyReleased
                try {
                        ...
                        java.sql.ResultSet rs = st.executeQuery(
                                        "SELECT b.Book_No No,b.ISBN,ac.Accession_No,b.Title,a.Author,b.Publisher,b.Edition,b.Row_No,b.Col_No FROM book b INNER JOIN accessionno ac ON b.Book_No=ac.Book_No INNER JOIN author_of_book ab ON b.Book_No = ab.Book_No INNER JOIN author a ON a.Author_Id = ab.Author_Id WHERE Title LIKE '%"
                                                        + title + "%'");
        ...
        private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_jTextField1KeyReleased
                try {
                        ...
                        java.sql.ResultSet rt = st.executeQuery(
                                        "SELECT B.*,A1.Accession_No,A2.Author FROM book B,accessionno A1,author A2,author_of_book A3 WHERE A1.Accession_No = '"
                                                        + accession_no
                                                        + "' AND B.Book_No = A1.Book_No AND B.Book_No = A3.Book_No AND A3.Author_Id = A2.Author_Id");
        ...
        private void jTextField2KeyReleased(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_jTextField2KeyReleased
                try {
                        ...
                        java.sql.ResultSet rs = st.executeQuery(
                                        "SELECT B.*,A1.Accession_No,A2.Author FROM book B,accessionno A1,author A2,author_of_book A3 WHERE B.ISBN = '"
                                                        + isbn1
                                                        + "' AND B.Book_No = A1.Book_No AND B.Book_No = A3.Book_No AND A3.Author_Id = A2.Author_Id");
                        jLabel20.setText("-");
                        jLabel21.setText("-");
                        ...
                        if (rs.next()) {
                                ...
                                java.sql.ResultSet rs2 = st
                                                .executeQuery("SELECT B.ISBN, COUNT(B.ISBN) FROM book B,accessionno A WHERE B.ISBN = '"
                                                                + isbn1
                                                                + "' AND B.Book_No = A.Book_No AND A.Accession_No NOT IN ( SELECT L.Accession_No FROM loan L) GROUP BY B.ISBN ");
                                if (rs2.next()) {
                                        jLabel23.setText(rs2.getString("COUNT(B.ISBN)"));
                                }
                                java.sql.ResultSet rs3 = st.executeQuery(
                                                "SELECT a.Accession_No FROM accessionno a INNER JOIN book b ON a.Book_No = b.Book_No WHERE b.ISBN = '"
                                                                + isbn1
                                                                + "' AND Accession_No NOT IN (SELECT Accession_No FROM loan)");
                                while (rs3.next()) {
